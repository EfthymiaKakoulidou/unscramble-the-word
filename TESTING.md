...
-   One bug that I came across while playing the game was that the hint was appearing with a time sleep of 2 seconds. This gave the time to the player to type something , even he/she was not asked to type anything. In this case the game took that, as the answer and validated it.  That caused confusion and bad user experience. I solved that by removing the time sleep and moving the message into the player's answer function. Now the hint is shown at  all times once used and I avoided having that weak 2 seconds part of the game.
